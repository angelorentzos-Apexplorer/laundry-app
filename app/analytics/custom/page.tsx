...
export default async function AnalyticsCustomPage({
  ...
  const rangeEnd = endOfDay(parsedTo);
  ...
  const label = `Από ${fromRaw} έως ${toRaw}`;
    ...
    <main className="space-y-8">
      <section className="rounded-2xl border bg-white p-6 space-y-5">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div>
            <h1 className="text-3xl font-bold">Analytics - Προσαρμοσμένο διάστημα</h1>
      ...
      <section className="rounded-2xl border bg-white p-6 space-y-5">
        <div>
          ...
          <p className="text-gray-600">
            Γρήγορη εικόνα για το διάστημα που επέλεξες.
          </p>
        </div>
      ...
      <section className="rounded-2xl border bg-white p-6 space-y-5">
        <div className="flex flex-wrap gap-3">
          <Link
            href={`/analytics/custom?from=${fromRaw}&to=${toRaw}&view=products`}
          ...
          <Link
            href={`/analytics/custom?from=${fromRaw}&to=${toRaw}&view=customers`}
        ...
        {activeView === "products" ? (
          <div className="space-y-4">
            ...
            {productRows.length === 0 ? (
              <div className="rounded-xl border bg-gray-50 p-4 text-gray-600">
                Δεν υπάρχουν παραλαβές προϊόντων για αυτό το διάστημα.
              </div>
            ) : (
          ...
          <div className="space-y-4">
            ...
            {customerRows.length === 0 ? (
              <div className="rounded-xl border bg-gray-50 p-4 text-gray-600">
                Δεν υπάρχουν εισπράξεις πελατών για αυτό το διάστημα.
              </div>
            ) : (
              <div className="overflow-x-auto">
                <table className="min-w-full border-separate border-spacing-y-2">
